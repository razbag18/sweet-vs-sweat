...
export default class FoodSearch extends React.Component {
  ...
  handleSubmit = e => {
    e.preventDefault()
    const url = `https://api.nutritionix.com/v1_1/search/${this.state.content}?results=0%3A10&cal_min=0&cal_max=50000&fields=item_name%2Citem_id%2Cnf_calories`
      const params = { 
        appId: `6abe098b`,
    ...
    return (
      <div className="food-search">
        ...
        <form className="search-form" onSubmit={this.handleSubmit}>
          <input placeholder="E.g. Cinnamon Doughnut... " onChange={e=> {this.setState({ content: e.target.value })} }/>
